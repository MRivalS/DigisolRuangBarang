...
$query = "SELECT * FROM peminjaman_barang WHERE admin_status = 'pending' ORDER BY id ASC";
...
if ($_SERVER['REQUEST_METHOD'] === 'POST' && isset($_POST['konfirmasi'])) {
    ...
    // Update status konfirmasi peminjam menjadi 'terkonfirmasi_peminjam'
    $updateQuery = "UPDATE peminjaman_barang SET admin_status = 'terkonfirmasi admin' WHERE id = '$id_peminjaman'";
    if ($koneksi->query($updateQuery)) {
        header("Location: konfirmasibarangadmin.php");
        exit;
    } else {
...
// Query untuk menampilkan peminjaman yang belum dikonfirmasi oleh peminjam
$query = "SELECT * FROM peminjaman_barang WHERE admin_status = 'terkonfirmasi admin' ORDER BY id ASC";
$lihat_data = $koneksi->query($query);
        ...
        <div id="layoutSidenav_content">
            <main>
                <div class="container-fluid px-4">
                    <h1 class="mt-4">Konfirmasi Peminjam Barang</h1>
                    ...
                    <div class="container">
                        ...
                        <div class="card mb-4">
                            <div class="card-header">
                                ...
                                View Data konfirmasi Peminjam Barang
                            </div>
