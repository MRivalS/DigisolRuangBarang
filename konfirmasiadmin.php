                ...
                <div class="container-fluid px-4">
                    ...
                    <div class="container">
                        <div class="confirmation-container">
                            <!-- Title -->
                            <div class="confirmation-title">KONFIRMASI DATA PEMINJAMAN</div>

                            <!-- Cards with spacing -->
                            <div class="row">
                                <!-- Card: Konfirmasi Peminjaman Barang -->
                                <div class="col-12 mb-3">
                                    <a href="konfirmasibarangadmin.php" class="confirmation-card d-flex align-items-center">
                                        <i class="fas fa-check-circle"></i>
                                        <div class="confirmation-card-text ms-3">
                                            Konfirmasi Data Pinjam <br><strong>BARANG</strong>
                                        </div>
                                ...
                                <div class="col-12 mb-3">
                                    <a href="konfirmasiruanganadmin.php" class="confirmation-card d-flex align-items-center">
                                        <i class="fas fa-check-circle"></i>
                                        <div class="confirmation-card-text ms-3">
                                            Konfirmasi Data Pinjam <br><strong>RUANGAN</strong>
                                        </div>
                                        <span class="confirmation-badge ms-auto"></span>
                                    </a>
                                </div>
